...
set(CMAKE_EXE_LINKER_FLAGS_INIT "-Wl,-m,aarch64linux -fuse-ld=lld")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-Wl,-m,aarch64linux -fuse-ld=lld")

# TODO: get rid of `-mno-implicit-float`
set(CMAKE_C_FLAGS "-ffreestanding -mno-implicit-float -nostdlib -target aarch64-unknown-none-elf" CACHE INTERNAL "")
set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS}" CACHE INTERNAL "")
set(CMAKE_ASM_FLAGS "-nostdlib -target aarch64-unknown-none-elf" CACHE INTERNAL "")
