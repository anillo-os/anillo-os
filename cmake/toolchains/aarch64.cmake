...
find_program(REAL_LD_PATH aarch64-apple-darwin-ld REQUIRED)
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "--ld-path=${LD_PATH} -Wl,-arch,arm64")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "--ld-path=${LD_PATH} -Wl,-arch,arm64")
