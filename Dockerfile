...
RUN apk add --no-cache clang lld python3 bash gcc libc-dev cmake make llvm-dev llvm-static qemu-img sgdisk dosfstools mtools git g++ fuse-dev util-linux-dev
