...
LIBJSON_TYPED_FUNC(bool, json_array_iterator, void* context, size_t index, sys_object_t* value);

LIBJSON_WUR ferr_t json_array_get(json_array_t* array, size_t index, sys_object_t** out_value);
