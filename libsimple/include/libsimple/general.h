...
#ifndef _LIBSIMPLE_GENERAL_H_
#define _LIBSIMPLE_GENERAL_H_
 ...
 *
 * Unlike simple_strncmp(), this function will NOT stop when it encounters a null terminator. It will ALWAYS compare @p n bytes.
 *
 ...
 * @note Standard C function.
 */
int simple_memcmp(const void* first, const void* second, size_t n);
 ...
 *
 * This function will skip any and all whitespace characters (as determined by simple_isspace()) at the beggining of the string.
