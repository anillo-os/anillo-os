...
FERRO_STRUCT_FWD(fchannel_server_context);
...
FERRO_STRUCT(fchannel_message_attachment_server_context) {
	fchannel_message_attachment_header_t header;
	fchannel_server_context_t* server_context;
};
...
FERRO_STRUCT(fchannel_server_context) {
...
FERRO_WUR ferr_t fchannel_server_context_retain(fchannel_server_context_t* server_context);
...
FERRO_WUR ferr_t fchannel_server_context_new(fchannel_realm_t* realm, const char* name, size_t name_length, fchannel_server_context_t** out_server_context);
