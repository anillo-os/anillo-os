 ...
 * @file
 *
 * POSIX-like wrappers over UEFI API for UEFI bootstrap.
 */
...
void* simple_memset(void* destination, int value, size_t count);
void* simple_memcpy(void* destination, const void* source, size_t count);
