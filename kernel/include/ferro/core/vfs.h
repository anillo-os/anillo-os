...
FERRO_OPTIONS(uint32_t, fvfs_descriptor_flags) {
...
/**
 * Exactly like fvfs_open_n(), but the path length is automatically determined with strlen().
 *
 * @see fvfs_open_n
 */
...
/**
 * Exactly like fvfs_open_rn(), but the path length is automatically determined with strlen().
 *
 * @see fvfs_open_rn
 */
...
/**
 * Exactly like fvfs_path_is_absolute_n(), but the path length is automatically determined with strlen().
 *
...
/**
 * Exactly like fvfs_path_component_first_n(), but the path length is automatically determined with strlen().
 *
