...
void ferro_ramdisk_init(ferro_ramdisk_t* in_ramdisk, void* phys, size_t in_ramdisk_size) {
...
void ferro_ramdisk_get_data(ferro_ramdisk_t** out_ramdisk, void** out_phys, size_t* out_size) {
	*out_ramdisk = ramdisk;
	*out_phys = ramdisk_phys;
	*out_size = ramdisk_size;
};
